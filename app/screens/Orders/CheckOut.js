            ...
            <View>
                ...
                >
                    ...
                    >
                        ...
                        <Text>{typeof Subtotal != "undefined" ? Subtotal.toFixed(2) : Subtotal}</Text>
                    </View>
                    <View
                        style={{
                            flexDirection: "row",
                    ...
                    >
                        ...
                        <Text>{typeof totalValue != "undefined" ? totalValue.toFixed(2) : totalValue}</Text>
                    </View>
                    <Text>===================================================</Text>
                    <View
                        style={{
                    ...
                    >
                        ...
                        >
                            ...
                            <Text>{cashTendered.toFixed(2)}</Text>
                        </View>
                        <View
                            style={{
                                flexDirection: "row",
